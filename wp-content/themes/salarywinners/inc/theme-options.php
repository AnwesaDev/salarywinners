 ...
 */
    ...
    $args = array(
        ...
        'global_variable'      => 'salarywinnersOptions',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'subtitle'         => __('Reset Password Email Template <br /> {{firstname}} {{lastname}} {{email}} {{resetlink}}', 'salarywinners'),
                'default'          => '{{resetlink}}',
                'args'   => array(
                    'teeny'            => true,
                    'textarea_rows'    => 10
